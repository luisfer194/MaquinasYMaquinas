const maquinasDB = [
  {
    ...
    precio: 1300000,
    descripcion:
      'Máquina de coser con 23 puntadas ideal para la confeccion de lenceria, acolchados y prendas medianas a gruesas. Diseñada para un uso doméstico con gran resistencia y estabilidad.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
  ...
  },
  {
    ...
    precio: 2900000,
    descripcion:
      'Máquina plana de costura recta con sistema direct drive incorporado y funciones automáticas avanzadas.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
  ...
  },
  {
    ...
    precio: 2200000,
    descripcion:
      'Máquina plana de costura recta con sistema direct drive incorporado, diseñada para confección de materiales.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
      'Sistema direct drive incorporado',
  ...
  },
  {
    ...
    precio: 1500000,
    descripcion:
      'Máquina plana de costura recta con sistema direct drive incorporado.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
      'Sistema direct drive incorporado',
  ...
  },
  {
    ...
    precio: 0,
    descripcion:
      'Máquina plana de costura recta mecatrónica con sistema direct drive incorporado, silenciosa y de alta velocidad.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
      'Sistema direct drive incorporado',
  ...
  },
  {
    ...
    precio: 1800000,
    descripcion:
      'Máquina fileteadora mecatrónica de alta velocidad con sistema direct drive.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
  ...
  },
  {
    ...
    precio: 2500000,
    descripcion:
      'Collarín recubridora mecatrónica industrial con motor direct drive y capacidad para trabajar con 1, 2 o 3 agujas. Ideal para ropa deportiva, pijamas, leggins y prendas livianas.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
  ...
  },
  {
    ...
    precio: 0,
    descripcion:
      'Máquina plana y zigzadora mecatrónica de 1 aguja, diseñada para todo tipo de materiales. Ofrece puntada recta y zigzag de hasta 6 mm con motor direct drive de bajo consumo.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
  ...
  },
  {
    ...
    precio: 2200000,
    descripcion:
      'Máquina industrial de poste con 2 agujas para puntadas rectas y refuerzo paralelo.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
  ...
  },
  {
    ...
    precio: 1000000,
    descripcion:
      'Máquina de coser mecánica doméstica ideal para principiantes y arreglos del hogar. Incluye 10 puntadas decorativas, brazo libre, ojal en 4 pasos y velocidad de hasta 750 puntadas por minuto. Es ligera, fácil de usar.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
  ...
  },
  {
    ...
    precio: 900000,
    descripcion:
      'Máquina de coser mecánica doméstica de nivel intermedio, ideal para proyectos creativos y arreglos del hogar. Cuenta con 23 puntadas utilitarias y decorativas, enhebrador automático, ojal en 4 pasos y estructura interna metálica que garantiza mayor durabilidad.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
      'Máquina mecánica doméstica intermedia',
      '23 puntadas decorativas e invisibles',
    ...
    especificaciones: {
      'Tipos de puntada': '23 puntadas decorativas',
      'Tipo de ojal': 'Ojal en 4 pasos',
  ...
  },
  {
    ...
    precio: 700000,
    descripcion:
      'Máquina de coser mecánica doméstica y portátil, ideal para principiantes y proyectos. Incluye 6 puntadas esenciales entre rectas y zigzag, ojalador en 4 pasos, estructura interna metálica y diseño compacto para un uso sencillo y duradero.',
    badge: '',
    badgeClass: '',
    caracteristicas: [
      'Máquina doméstica portátil',
